...
class TfExamplesNode(object):
    ...
    def __init__(self):
        ...
        self.last_orientation_increment_ = quaternion_from_euler(0, 0, 0.05)
    ...
    def timerCallback(self, event):
        ...
        q = quaternion_multiply(self.last_orientation_, self.last_orientation_increment_)
        ...
        if self.rotations_counter_>=100:
            self.last_orientation_increment_ = quaternion_inverse(self.last_orientation_increment_)
            self.rotations_counter_ = 0
    ...
    def getTransformCallback(self, req):
        ...
        rospy.loginfo('The request transform is: %s', requested_transform)
